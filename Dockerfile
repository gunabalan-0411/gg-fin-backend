...
RUN pip install jellyfish indic-transliteration google-auth-oauthlib google-api-python-client xlrd google-cloud-aiplatform PyMuPDF opencv-python-headless numpy
